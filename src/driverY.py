...
#
parser.add_argument('--bottleneck_l', type=int, default='6',  help='size of bottleneck layer for the linear part')
#
parser.add_argument('--bottleneck_c', type=int, default='6',  help='size of bottleneck layer for the control part')
#
...
#
parser.add_argument('--fixed_A', type=int, default=1,  help='fix rotation matrix') 
...
# transfer to tensor
# Xtrain = torch.from_numpy(X).float().contiguous()
print(Xtrain.min())
print(Xtrain.max())
print(Xtrain.mean())
print(Xtrain.std())
X_nolag = normalize(Xtrain,norm_scheme=0)
...
# Add lags
Xtrain = add_lags(X_nolag, args.lags, freq=1)
print(Xtrain.shape)
Xtrain =add_channels(Xtrain)
...
#==============================================================================
print(Xtrain.shape)
model = koopmanAEY(m, n, args.lags, args.bottleneck_l, args.bottleneck_c, args.steps, args.steps_back,
 args.alpha, args.init_scale, args.fixed_A)
print('koopmanAEY created')
...
# Start training
#==============================================================================
model, optimizer, epoch_hist = trainY(model, train_loader,
                    ...
                    nu = args.nu, eta = args.eta, backward= args.backward,
                    steps=args.steps, steps_back=args.steps_back, 
                    print_every=args.print_every, fixed_A =args.fixed_A)
